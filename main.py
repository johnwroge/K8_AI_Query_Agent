...
class K8sAssistant:
    ...
    def query_gpt(self, query: str, cluster_info: dict) -> str:
        ...
        try:
            system_prompt = f"""You are a Kubernetes cluster assistant. Analyze the cluster information and answer questions precisely. 
            ...
            Response Guidelines:
            1. Provide concise, direct answers
            2. Use raw, unformatted values
            3. If a specific detail is not found, respond with "Unknown"
            4. For multiple results, use comma-separated values without spaces
            5. Focus on extracting exact information from the cluster data
            ...
            - For configmaps: Extract configuration details
            """
